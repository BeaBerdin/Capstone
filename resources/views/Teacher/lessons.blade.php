...
@php
    ...
    $courseCanBeModified = in_array(
        strtolower(trim((string) ($course->status ?? 'draft'))),
        ['draft', 'rejected'],
        true
    );
...
<div class="min-h-screen bg-[#f8f9fc]">
    ...
    <main class="px-5 py-7 sm:px-6 lg:px-8 lg:py-9">
        ...
        <div class="mx-auto max-w-[1500px]">
                ...
                @else
                    ...
                    <div
                        class="inline-flex h-11 items-center
                               ...
                               bg-slate-100 px-5 text-sm
                               font-semibold text-slate-500"
                        title="Course content is locked while pending approval or published."
                    >
                        <svg
                            class="h-4 w-4"
                            viewBox="0 0 24 24"
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            class="inline-flex h-10
                                                   ...
                                                   transition
                                                   hover:bg-violet-100"
                                            title="View this quiz in read-only mode"
                                        >
                                            View Quiz
                                            <span aria-hidden="true">→</span>
                                        </a>
            ...
            @if($totalLessons > 0 && $courseCanBeModified)
