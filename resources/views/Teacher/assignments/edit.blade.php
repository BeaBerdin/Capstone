<x-layouts::app :title="'Edit Assignment - ' . $assignment->title">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-slate-500">
                    Update the instructions, scoring, deadline, or publication status.
                </p>
            </div>
                ...
                <div class="space-y-5 p-5 sm:p-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($lessons as $lesson)
                                    <option
                                        value="{{ $lesson->id }}"
                                        @selected((string) old('lesson_id', $assignment->lesson_id) === (string) $lesson->id)
                                    >
                                        {{ $lesson->title }}
                                    </option>
                                @endforeach
                    ...
                    <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200
                        ...
                        <input
                            ...
                            name="is_published"
                            value="1"
                            @checked((bool) old('is_published', $assignment->is_published))
                        ...
                        <span>
                            ...
                            <span class="mt-0.5 block text-xs text-slate-500">
                                Enrolled students can access it once the course is published.
                            </span>
                        </span>
                    </label>
                </div>
