            ...
            >
                ...
                <div
                    class="flex h-14 w-14 items-center justify-center rounded-2xl
                           bg-linear-to-br from-purple-600/20 to-indigo-600/20
        ...
        <flux:sidebar.nav>
            ...
            >
                ...
                @if(auth()->user()->hasRole('super_admin'))
                    ...
                    {{-- Reports route will be added later --}}
                    {{-- Do not use route('reports.index') until the route exists. --}}
...
@endif
                ...
                @elseif(auth()->user()->hasRole('teacher'))
                    ...
                    @php
                        $teacherCoursesCount = \App\Models\Course::where(
                            'teacher_id',
                            auth()->id()
                        )->count();

                        $teacherStudentsCount = \App\Models\Enrollment::whereHas(
                            'course',
                            function ($query) {
