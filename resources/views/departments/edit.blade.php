            ...
            <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        Update the details of <span class="font-semibold text-gray-900 dark:text-white">{{ $department->name }}</span>.
                    </p>
                </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div class="border-b border-gray-200 px-6 py-5 dark:border-neutral-800">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Changes will apply to all users assigned to this department.
                </p>
            </div>
            ...
            <form action="{{ route('departments.update', $department) }}" method="POST" class="px-6 py-6">
                ...
                <div class="mb-8">
                    ...
                    <textarea name="description"
                              ...
                              class="block w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-purple-500 focus:ring-purple-500 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white dark:placeholder:text-gray-500 dark:focus:border-purple-500">{{ old('description', $department->description) }}</textarea>
                ...
                {{-- Actions --}}
                <div class="flex items-center justify-between gap-3 border-t border-gray-200 pt-6 dark:border-neutral-800">

                    <button type="submit"
                            form="delete-department"
                            onclick="return confirm('Are you sure you want to delete this department?');"
                            class="inline-flex items-center gap-2 rounded-lg border border-red-200 px-4 py-2.5 text-sm font-semibold text-red-600 transition hover:bg-red-50 dark:border-red-900/50 dark:text-red-400 dark:hover:bg-red-950/30">
                        Delete
                    </button>
